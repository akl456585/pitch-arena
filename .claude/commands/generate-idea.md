...
The content bar: this pitch will be read by people browsing Pitch Arena for
entertainment and insight. It must be interesting enough that someone would
share it. "Competent but boring" is a failure mode — a weird idea with a
sharp argument beats a safe idea with a polished deck.

## Variety knobs

Pick one of each at random — but lean into whichever combo lets you make the
most interesting pitch, not the safest one. The goal is to generate judge
disagreement — if all 5 judges would obviously agree, the idea is too safe.
...
- **Category**: SaaS, Consumer, Marketplace, Fintech, Health, Education,
  ...
  Sustainability, Food & Beverage, Weird/Experimental, Logistics,
  Government/Civic, Insurance, Legal, Agriculture, Space, Defense
- **Vibe**: realistic-viable, ambitious-moonshot, chaos-goblin,
  boring-but-profitable, mission-driven, contrarian-thesis,
  unsexy-but-massive, ethically-thorny
- **Target archetype**: solo-prosumer, enterprise team, gen-z consumer,
  small business owner, hobbyist community, regulated industry,
  aging population, blue-collar workforce, developing-market user

Bad idea names are generic ("AI Assistant"). Good names are concrete
("ParkBench — turn unused city benches into wifi hotspots").

Avoid these played-out angles unless you have a genuinely new take:
- "AI for X" where X is a commodity task (writing, scheduling, summarizing)
- Another dev tool for a problem that already has 20 solutions
- A marketplace that's just "Uber for Y"
- Anything whose tagline could be generated by autocomplete
